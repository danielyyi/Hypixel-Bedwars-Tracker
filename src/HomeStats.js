...
function HomeStats() {
    ...
    function updateState(count) {
        setState({
           ...
           bwPlayerPercent:( Math.round(100 * (count.games.BEDWARS.players/count.playerCount)))
        }, [])
    }
        ...
        <div>
            ...
            <div className="home-stat-wrapper">
                <div className="home-stat-card" >
                 Current Bedwars Player Count: <span style={{color:'lime'}}>{state.bwPlayerCount}</span> Players ({state.bwPlayerPercent}%)
                </div>
            </div>
            </>
            :null}
